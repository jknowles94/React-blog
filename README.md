...
Page layout: 
   Nav - [Logo, Home, Create article, user profile]
   Home page:
      - featured blog
      - list of blogs
      - add to favourite
   ...
   User page (create data in firebase - dummy name then list of ids for articles to get):
      - user details form to update in firebase
      - list of favourited articles
   Footer
